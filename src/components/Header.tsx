  ...
  return (
    <header className="text-center py-10" id="header">
      <div className="flex w-full sm:flex-row flex-col justify-between items-start sm:items-center relative gap-4">
        <h1 className="sm:text-4xl lg:text-6xl text-2xl w-full text-start font-bold text flex flex-col justify-start items-start gap-2">
      ...
      <div className="flex flex-col w-full text-left mt-12 justify-start items-start gap-8">
        <p className="sm:text-xl text-lg">
          Hello, my name is Mohammadreza. I am a Frontend developer with a
          passion for creating <span className="text-indigo-500">dynamic </span>
          and <span className="text-indigo-500">responsive </span>
          websites.
        </p>
        <a
          href="#contact"
          className="mt-5 inline-block bg-indigo-500 cursor-pointer text-white py-3 px-8 rounded"
        >
          Contact me
        </a>
      </div>
